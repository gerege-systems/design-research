...
- [ ] Том текст, icon ≥3:1 — **бүх фон дээр** (background, background-muted, card); `--border-input` зориуд `--border`-тэй ижил, харин `prefers-contrast: more` дээр ≥3:1 (07-accessibility.md)
