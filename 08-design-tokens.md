...
| `--border-input` | `hsl(214 32% 91%)` | `hsl(217 33% 17%)` | **Бүх interactive control-ийн хил** (form элемент, outline товч) — `--border` (card)-тай ижил: `background` дээр 1.24:1 / 1.33:1, `background-muted` дээр 1.13 / 1.12. 2026-09-14-ний удирдлагын шийдвэрээр WCAG 1.4.11-ийн 3:1-ээс доош; `prefers-contrast: more` үед 55% / 45% (3:1) руу буцна |
