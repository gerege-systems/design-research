...
- UI компонент, icon, input border (non-text): **≥3:1** — тэр элемент суудаг **бүх** фон дээр (`--background`, `--background-muted`, card, sidebar); нэг фон дээр л шалгаад орхихгүй. **Үл хамаарах нэг:** `--border-input` (form control, outline товчны хил) 2026-09-14-ний шийдвэрээр card-ын хилтэй ижил, 3:1-ээс доош; `prefers-contrast: more` үед 3:1 руу буцна (04-visual-details.md).
